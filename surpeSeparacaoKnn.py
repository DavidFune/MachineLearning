...
########acresentando a função de contorno e seu classificador
            

            
fig, ax1 = plt.subplots(nrows=1)

ax1.contour(seq,seq, Z, levels = 0, linewidths =1, colors='K')
ctr1 = ax1.contourf(seq,seq, Z, levels = 1, alpha=0.3, colors=['red','blue'])
